...
{ 
 ...
 void init(){
  ...
  com.add(ComB,BorderLayout.EAST);
 ...
 public void valueChanged(TreeSelectionEvent e)
 {
  ...
  ComB.addItemListener(new ItemListener() {
	...
	public void itemStateChanged(ItemEvent arg0) {
		if(arg0.getItem().toString().equals("한국어")) {
			JOptionPane.showMessageDialog(null, "한국어");
			 FView.title[0]= "이름";
			 FView.title[1]="크기";
			 FView.title[2]="수정된 날짜";
			 FView.at=new ATable(FView.title);
			 FView.jt=new JTable(FView.at);
		}
		else {
			 FView.title[0]= "name";
			 FView.title[1]="size";
			 FView.title[2]="modified day";
			 FView.at=new ATable(FView.title);
			 FView.jt=new JTable(FView.at);
		}
	}
...
static String title[]= {"이름", "크기","수정한 날짜"};
 static ATable at=new ATable(title);
